        ...
        <div class="col-md-12 text-center">
            ...
            <div>
                ...
                <div class="mb-5 text-right">
                    ...
                    <a href="ontheway.php"><button class="btn btn-danger">Back</button></a>
                </div>
             ...
             AND agent_name = '$agent' AND status = '2'";
                            } elseif (isset($_GET['city'])) {
                                $city = $_GET['city'];
                                $sql = "SELECT * FROM parcels 
             WHERE sender_address LIKE '%$city%' AND status = '2'";
                            } elseif (isset($_GET['agent_name'])) {
                                $agent = $_GET['agent_name'];
                                $sql = "SELECT * FROM parcels WHERE agent_name = '$agent' AND status = '2'";
                            } elseif (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                $from_date = $_GET['from_date'];
                                $to_date = $_GET['to_date'];
                                $sql = "SELECT * FROM parcels WHERE date BETWEEN '$from_date' AND '$to_date' AND status = '2'";
                            } else {
                                $sql = "SELECT * FROM parcels WHERE status = '2'";
                            }
                            $stmt = $conn->prepare($sql);
