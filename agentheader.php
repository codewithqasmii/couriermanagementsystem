        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>AGENT</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="feeback.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Feedback</a>
                    <a href="order.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Orders</a>
                    <a href="invoice.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Track</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex"><?php echo $_SESSION['agent']; ?></span>
                        </a>
